...
const HeadlineContactusSection = () => {
    return (
        <section
            className="dark:bg-[#06070A] px-6 dark:text-[#A4B1CD] h-full w-full bg-black relative py-[140px] pb-[100px] flex justify-center lg:items-center items-start flex-col overflow-hidden"
        >
            <div className="flex flex-col gap-4 items-center">
                <div className="w-full lg:max-w-[596px] flex flex-col gap-4">
                    <h1 className="font-bold xl:text-5xl text-2xl dark:text-[#fff] lg:text-center">Fale connosco</h1>
                    <p className="font-medium text-base dark:text-[#DDE2EE] lg:text-center">
