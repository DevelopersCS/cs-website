...
const HeadlineSection = () => {
  ...
  return (
    <section
      className={"dark:bg-[#06070A] dark:text-[#A4B1CD] bg-white relative pt-[140px] bg-background-light bg-no-repeat bg-right-bottom bg-cover mx-auto pb-4 w-full flex justify-center items-center flex-col lg:px-8 px-6"}
    >
      <div className="w-full flex max-w-[1216px]  z-20 gap-10 justify-between items-center flex-col lg:flex-row">
        <div className="text-white flex gap-6  minMobile:max-w-[600px] lg:max-w-[520px] w-full flex-col minMobile:justify-center  minMobile:items-center lg:items-start minMobile:text-center lg:text-start">
          ...
          <h1 className="font-bold dark:text-white text-black lg:text-5xl md:text-4xl text-[32px] leading-[120%]">Defenda seus dados e operações com nossa expertise.</h1>
          <p className="lg:text-lg text-base font-normal leading-[150%] dark:text-white text-[#333232] text-opacity-70">Soluções de cibersegurança para empresas que priorizam a segurança dos seus dados e a confiança dos seus clientes.</p>
