    ...
    return (
        ...
        >
            ...
            <div className="flex flex-col gap-6 order-1 max-w-full w-full px-6 lg:px-0">
                {title && <h1 className="font-bold text-black dark:text-[#BCD1F0] text-[24px]">{title}</h1>}
                {subtitle && <h2 className="dark:text-white text-black font-bold text-[30px] leading-[120%]">{subtitle}</h2>}
                        ...
                        <li key={index}>
                            <div className="flex gap-6">
                                ...
                                <div className="flex flex-col gap-2">
                                    {item.title && <h3 className="dark:text-white text-black font-bold text-lg">{item.title}</h3>}
                                    {item.description && <p className={`font-medium text-[#5E5E5F] leading-[120%] text-base  ${!item.title ? "dark:text-white" : "dark:text-[#BCD1F0]"}`}>{item.description}</p>}
                                </div>
                            </div>
                        </li>
                    ))}
